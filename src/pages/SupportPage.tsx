...
const HELP_SECTIONS: {
  ...
  },
  {
    ...
    items: [
      ...
      { heading: 'Navigation', body: 'Use the sidebar on the left to switch between Dashboard, Projects, AI Assistant, Timesheets, and Support. On mobile, tap the menu icon in the top bar. Settings and your account are at the bottom of the sidebar.' },
  ...
  },
  {
    ...
    items: [
      { heading: 'What is AI Assistant?', body: 'A Pro feature that lets you describe your working days in plain English. The AI extracts all the details \u2014 role, call time, wrap time, breaks, day type \u2014 and fills in the calculator for you.' },
  ...
  },
  {
    ...
    items: [
      ...
      { heading: 'Pro plan', body: 'Unlocks AI Assistant, full invoicing with email delivery, bookkeeping integrations, calendar feed, and project sharing. Available monthly or annually (save 28% on yearly).' },
