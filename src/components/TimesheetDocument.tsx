  ...
  return (
    <div style={{ backgroundColor: '#ffffff', fontFamily: "'JetBrains Mono', 'Courier New', monospace", color: '#1F1F21' }}>
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
            <div style={{ width: 26, height: 26, background: '#FFD528', borderRadius: 4, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <img src={logoImg} alt="CrewDock" style={{ width: 16, height: 16, objectFit: 'contain', mixBlendMode: 'multiply' }} />
            </div>
      ...
      {sorted.map((day, i) => {
        ...
        return (
          <div key={day.id} data-ts-day style={{ borderBottom: i < sorted.length - 1 ? '1px solid #ebebeb' : 'none' }}>
      ...
      {/* ── Footer ── */}
      <div data-ts-day style={{ background: '#fafaf8', borderTop: '1px solid #e8e8e6', padding: '20px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
