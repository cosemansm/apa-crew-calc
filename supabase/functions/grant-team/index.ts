// supabase/functions/grant-team/index.ts
// Admin-only — grants team subscription status to a user.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!user_id || !team_id) {
      return new Response(JSON.stringify({ error: 'user_id and team_id required' }), {
